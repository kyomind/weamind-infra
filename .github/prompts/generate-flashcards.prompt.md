...
- `learning/lessons/rules/report-note.md`
...
3. `learning/lessons/rules/report-note.md`
...
卡片寫法應符合 `learning/lessons/rules/report-note.md` 的規則：
...
6. 更新後的 `05-note.md` 仍符合 `learning/lessons/rules/report-note.md` 的卡片格式
