...
- `references/lesson-plugins/implementation/implement-heavy-mode.md` 承接 implement-heavy 的 mode 規則與 `06` 初始化、自檢邊界。
- `references/lesson-plugins/implementation/implement-heavy-lesson-template.md` 承接 implement-heavy 的 mode 專用骨架；常態 `learning/lessons/lesson-template.md` 回到 01-05。
