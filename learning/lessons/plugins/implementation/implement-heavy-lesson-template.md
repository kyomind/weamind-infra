...
> 使用方式：先讀 `learning/AGENTS.md`、`learning/lessons/AGENTS.md`、`learning/lessons/plugins/implementation/AGENTS.md`、`learning/lessons/plugins/implementation/implement-heavy-mode.md`，確認今天真的屬於 implement-heavy mode，再用本檔建立 mode 專用骨架。
...
補充：若今天的主線超過 2 個步驟，直接繼續往下新增 `Step 3 小標題`、`Step 4 小標題`、`Step 5 小標題`。每個 step 盡量只承接一個主要驗證點或一組緊密相關的操作，避免單一步驟過大。
